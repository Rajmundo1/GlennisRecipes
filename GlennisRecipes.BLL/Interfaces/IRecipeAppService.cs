...
namespace GlennisRecipes.BLL.Interfaces
{
    public interface IRecipeAppService
    {
        ...
        Task<CreateRecipeViewModel> CreateNewRecipeAsync(CreateRecipeViewModel recipe, string userId);
        ...
        Task<RecipeDetailsViewModel> UpdateRecipeAsync (RecipeDetailsViewModel recipeDetailsViewModel);
